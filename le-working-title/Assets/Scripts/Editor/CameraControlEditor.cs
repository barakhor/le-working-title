...
namespace Editor
{
    ...
    public class CameraControlEditor : UnityEditor.Editor
    {
        ...
        {
            get {return target as CameraControl;}
        }
        ...
        private void MovementTab()
        {
            ...
            Camera.TargetFollow =
                EditorGUILayout.ObjectField("Target to follow: ", Camera.TargetFollow, typeof(Transform), true) as Transform;
        ...
        private void HeightTab()
        {
            ...
            if(Camera.UseScrollwheelZooming)
                Camera.ScrollWheelZoomingSensitivity =
                    EditorGUILayout.FloatField("Scrollwheel sensitivity: ", Camera.ScrollWheelZoomingSensitivity);
